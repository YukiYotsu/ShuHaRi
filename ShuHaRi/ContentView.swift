...
struct ContentView: View {
    ...
    var body: some View {
        TabView {
                            ...
                            VStack(alignment: .leading) {
                                ...
                                if !exhibit.startTime.isEmpty {
                                    Text(exhibit.startTime)
                                        .foregroundColor(colorForTime(exhibit.startTime, exhibit.endTime)) //色を変更するよう設定しているが、そもそも表示の順序を下にするなどif文で制御したほうがいいかも
                                }
                            }
            ...
            NavigationView{
                ...
                .navigationTitle(localizedString("ShuHaRi"))
            }
            .tabItem {
                Image(systemName: "pin.fill")
                Text(localizedString("ShuHaRi"))
            }
        }
    ...
    func localizedString(_ key: String) -> String {
        ...
        case "🇯🇵日本語":
            return ["Program": "プログラム", "Home": "ホーム", "ShuHaRi": "守破離とは", "Search exhibits": "出展を検索する", "Notifications": "通知設定"][key] ?? key
        case "🇩🇪Deutsch":
            return ["Program": "Programm", "Home": "Startseite", "ShuHaRi": "ShuHaRi", "Search exhibits": "Exponate suchen", "Notifications": "Benachrichtigungen"][key] ?? key
        // それ以外はそのキーのまま返す
        default:
            return key
        }

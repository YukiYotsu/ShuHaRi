...
let notifications = [
    ...
    Notification(title: "Test Notification", body: "Look forward to today's exhibitions!", hour: 9, minute: 30) // 9:30 イベント30分前
]
